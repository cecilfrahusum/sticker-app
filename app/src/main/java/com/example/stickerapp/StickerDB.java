...
public class StickerDB extends ViewModel {
    ...
    public StickerDB() {
        ...
        markers.add(new Sticker(icecreamSticker, "Go ITU anti-fascist sticker patrol!", new Date(1)));
        markers.add(new Sticker(metroSticker, "Smash the patriarchy", new Date(1)));
        markers.add(new Sticker(concertSticker, "Let's remove this nazi crap please", new Date(1)));
        markers.add(new Sticker(jurSticker, "Another gross sticker, boo!", new Date(1)));
    }
